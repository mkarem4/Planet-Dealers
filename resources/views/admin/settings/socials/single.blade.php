...
@section('content')
    ...
    <div class="page-content-wrap">
        <div class="row"><span>{{$errors}}</span>
            <div class="col-md-12">
                <form class="form-horizontal" id="jvalidate" method="post" @if(isset($edit)) action="/admin/settings/social/update" @else action="/admin/settings/social/store" @endif enctype="multipart/form-data">
                    {{csrf_field()}}
