...
@section('content')
    <ul class="breadcrumb">
        ...
        <li>{{word('settings')}}</li>
        <li><a href="/admin/settings/brands/index">{{word('banners')}}</a></li>
        @if(isset($edit))
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" id="jvalidate" method="post" @if(isset($edit)) action="/admin/settings/brand/update" @else action="/admin/settings/brand/store" @endif enctype="multipart/form-data">
                    {{csrf_field()}}
